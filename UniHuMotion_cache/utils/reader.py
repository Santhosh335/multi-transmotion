...
import random
import numpy as np
from .data import SceneRow, TrackRow_UniHuMotion
        ...
        with open(input_file, 'r') as f:
            for line in f:
                ...
                if track is not None:
                    track_array = line.get('track').values()
                    row = TrackRow_UniHuMotion(*track_array, track.get('prediction_number'), track.get('scene_id'))
